...
Exploring the Big Mac Index from and Australian perspective. Show which currencies the AUD is over / under values with over time. 
...
Using the methodology below, visualize the AUD under/over values against given currencies 

A Big Mac costs **A$6.55** in Australia and **US$5.71** in the United States. The implied exchange rate is **1.15**. The difference between this and the actual exchange rate, **1.43**, suggests the Australian dollar is ***19.8% undervalued***
