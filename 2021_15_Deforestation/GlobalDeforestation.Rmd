...
A Pareto chart visually exposes the “vital few” in the “useful many”. Here is a pareto chart using ggplot... 

```{r paretoChart, warning=FALSE, message=FALSE}
...
This is an attempt to make the pareto easier to read and more visually appealing without losing the usefulness (aka turning it on its side). 

```{r Hpareto, warning=FALSE, message=FALSE}
# Shape the data for ggplot...
loss_causes <- brazil_loss %>% 
    pivot_longer(
        cols = commercial_crops:small_scale_clearing, 
